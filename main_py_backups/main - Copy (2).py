...
def highlight_word_by_index(index, words, text_widget):
    # Calculate the start and end positions for the current word
    current_text = text_widget.get("1.0", "end-1c")  # Get the full text in the widget
...
def main():
    ...
    speed_var = tk.DoubleVar(value=0.3)  # Default speed is 2 seconds per word (0.5 WPS)
    ...
    speed_value_label = tk.Label(root, text="0.3 seconds per word", font=("Helvetica", 8), fg="gray")
